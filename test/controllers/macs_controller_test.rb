...
class MacsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mac" do
    assert_difference('Mac.count') do
      post macs_url, params: { mac: { color: @mac.color, description: @mac.description, price: @mac.price, size: @mac.size, type: @mac.type } }
    end
  ...
  test "should update mac" do
    patch mac_url(@mac), params: { mac: { color: @mac.color, description: @mac.description, price: @mac.price, size: @mac.size, type: @mac.type } }
